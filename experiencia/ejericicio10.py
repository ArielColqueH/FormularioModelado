...
def mostrarMatrizDouble(matriz):
    ...
    for i in range(f):
        ...
        print(cad)
#primera opcion de llenar tus datos
#datosY = [[68.6], [86.8], [75.6], [87.9], [72.0], [83.4], [75.0], [78.2], [79.6], [87.3], [81.9], [72.0], [73.0],[89.4], [81.6], [88.6], [80.0], [81.8], [76.6], [75.2], [68.9], [89.3], [83.2], [78.6], [72.1], [82.0],[79.2], [89.2], [74.3], [72.0], [81.3], [78.9], [88.7], [84.6], [84.0], [80.9], [82.0]]
"""datosX = [[1, 22, 6, 2],
          [1, 19, 6, 2.5],
          [1, 19, 6, 2],
          [1, 22, 6, 5],
